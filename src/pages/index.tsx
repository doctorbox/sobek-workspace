    ...
    <div className="flex flex-col w-full">
      ...
      <section className="relative h-[950px] w-full">
        ...
        <div className="relative z-10 ml-5 mt-10 flex">
          <Image src="/logo.svg" alt="Logo" width={94} height={94} className="p-[15px]" />
          <MainHeading name="Jane" />
        </div>
        <div className="relative z-10 mt-[80px] mx-[140px]">
          <div className="flex text-white">
            <span className="text-5xl basis-124 grow-0 shrink-0 w-[450px]">Your research journey is unique.</span>
            <span className="text-2xl">Sobek AI is designed to support researchers like you, ensuring that cutting-edge mRNA vaccine development capabilities are accessible to scientists worldwide and adaptable to your unique needs.</span>
          </div>
        </div>
      ...
      <section className=" mx-auto px-4 -mt-16 z-10 pb-5 bg-gradient-to-b from-[#f4f4f5] to-[#ffffff]">
        <div className="space-y-12">
          <div className="bg-white rounded-lg px-6 -mt-[60px] pb-8">
            <h2 className={`${inter.className} text-[48px] font-semibold mb-4 pt-[80px] text-center text-indigo-900`}>Your research</h2>
            <h3 className="text-xl text-center mb-5">Jon, based on uploaded documents, we’ve prepared the following project summary.</h3>
